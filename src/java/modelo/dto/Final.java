...
@NamedQueries({
    ...
    , @NamedQuery(name = "Final.findByJustificativo", query = "SELECT f FROM Final f WHERE f.justificativo = :justificativo")
    , @NamedQuery(name = "Final.findByFecha", query = "SELECT f FROM Final f WHERE f.fecha = :fecha")
    , @NamedQuery(name = "Final.findByFechaExtra", query = "SELECT f FROM Final f WHERE f.fechaExtra = :fechaExtra")})
public class Final implements Serializable {
    ...
    public Final(Integer id, Date fecha) {
        this.id = id;
        this.fecha = fecha;
    }

    public Final(Date fecha, Equipo ganador, Equipo perdedor) {
        this.fecha = fecha;
